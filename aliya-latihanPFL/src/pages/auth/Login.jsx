  ...
  return (
    <div>
      <div className="text-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-700 font-poppins">Udah laper ya? 🍽️</h2>
        <p className="text-teks-samping text-sm mt-1">Masuk ke akunmu dulu ya!</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" disabled={loading}
          className="w-full font-semibold py-2 px-4 rounded-xl transition duration-300 disabled:opacity-60"
      ...
      <p className="text-center text-sm text-gray-500 mt-5">
        Belum punya akun?{" "}
        <Link to="/register" className="text-hijau font-semibold hover:underline">Klik register</Link>
      </p>
      <p className="text-center text-sm text-gray-400 mt-2">
        <Link to="/forgot" className="hover:underline hover:text-hijau">Lupa password?</Link>
      </p>
    </div>
  );
}
