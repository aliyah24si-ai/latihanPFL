  ...
  return (
    <div>
      ...
      <div className="px-4 mb-6">
        ...
        >
          <div>
            <p className="text-white/80 text-sm font-barlow">Selamat datang kembali! 👋</p>
            <h2 className="text-2xl font-poppins font-bold text-white mt-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-4 mb-6">
        {cards.map((card, i) => (
          <div
            key={i}
            className="rounded-3xl p-5 flex flex-col gap-3 shadow-sm"
            ...
            {recentOrders.map((order, i) => (
              <div key={i} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                <div className="flex items-center gap-3">
                  <div
                    className="w-9 h-9 rounded-2xl flex items-center justify-center text-sm font-bold text-gray-700"
              ...
              <div key={i}>
                ...
                <div className="w-full bg-gray-100 rounded-full h-2.5">
                  <div
                    ...
                    style={{ width: `${item.persen}%`, backgroundColor: item.warna }}
                  />
                </div>
              </div>
            ))}
